...
export function SimulatorForm({
  ...
  const validate = (): boolean => {
    ...
    if (!formData.profile)
      newErrors.profile = "Por favor seleccione un perfil.";
    const payment = parseFloat(formData.paymentValue);
    if (isNaN(payment) || payment <= 0)
      newErrors.paymentValue = "Ingrese un valor de cuota válido.";
    const term = parseInt(formData.termMonths);
    if (isNaN(term) || term <= 0 || term > 120)
      newErrors.termMonths = "Ingrese un plazo válido (1-120).";
        ...
        >
          ...
          <div className="form-group space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-8 ${
                  errors.paymentValue ? "border-destructive" : ""
                }`}
              />
            </div>
            {errors.paymentValue && (
          ...
          <div className="form-group space-y-2">
            ...
            <Select
              ...
              onValueChange={(value: "inicial" | "saldo") =>
